        ...
        <div className="aspect-square p-4 grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-4">
          {
            Array(6).fill().map((_, i) => (
              <Bento key={i} className="col-span-1 text-center hover:scale-[1.01] transition-transform" text={about}/>
            ))
          }
        </div>
      </div>
